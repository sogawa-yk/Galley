...
module "vcn" {
  ...
  create_internet_gateway  = true   # パブリックアクセス時
  create_nat_gateway       = true   # プライベートサブネット用
  create_service_gateway   = true   # OCI内部サービス用
...
## Private Security List — 動的生成パターン
